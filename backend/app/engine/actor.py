...
FINISHED_GOODS_PRICE: int = 9500  # milliunits per finished unit (urban buyer) — moderate, legible
FINISHED_GOODS_PRICE_RIVER_EXTRA: int = 800  # River Contracts extra — kept but not the lever
HIRE_LABOUR_COST: int = 400
HIRE_LABOUR_COST_REPUTATION: int = 200  # Crisis Reputation discount (now unused — 3 legacies)
LAND_NETWORK_EXTRA_GRAIN_PER_TURN: int = 15  # deliberately weak vs labour*10 cap
# Moderate, legible demand shift — city wants finished goods now, not "grain is worthless"
EPILOGUE_RAW_DEMAND: tuple[int, ...] = (280, 220, 180)  # turns 5,6,7 vs agriculture 410
# Crisis threshold kept for reference (now unused)
CRISIS_INVENTORY_THRESHOLD: int = 80
